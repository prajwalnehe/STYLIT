    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="text-center mb-12">
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              At STYLEIT, we celebrate the timeless grace of Indian women through the nine yards of elegance — the saree. Our name reflects what we stand for — a world of sarees that unites the diverse weaves, colors, and stories of India under one roof.
            </p>
        ...
        <div className="max-w-3xl mx-auto mb-20 text-center bg-gradient-to-br from-amber-50 to-white border-2 border-amber-100 rounded-lg p-12 shadow-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            To revive, preserve, and promote India's rich handloom heritage while blending it with contemporary elegance. STYLEIT strives to make traditional artistry accessible to every woman who believes in grace with authenticity.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-light tracking-wider mb-8 text-gray-900">
            CELEBRATE EVERY MOMENT WITH STYLEIT
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Be it a Kanjivaram that shines at weddings, a soft linen saree for daytime charm, or a Banarasi that turns every occasion into a celebration — STYLEIT brings you collections that make every woman feel special.
          </p>
          ...
          <p className="text-xl font-light text-amber-700 italic tracking-wide">
            Discover your story. Drape your tradition. Only at STYLEIT.
          </p>
        </div>
